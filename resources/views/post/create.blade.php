        ...
        <div class="col-sm-12 col-md-12">
          <form action="{{route('post.store')}}" id="postForm" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" placeholder="Job location" class="form-control @error('veneu') is-invalid @enderror" name="veneu" value="{{ old('veneu') }}" required >
              @error('veneu')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control @error('specifications') is-invalid @enderror" name="specifications" value="{{ old('specifications') }}" required>{{ old('specifications') }}</textarea>
            </div>
...
<script>
  $(document).ready(function(){
    ...
    placeholder: 'Job Reqirement , Job specificationss etc ...',
    theme: 'snow'
    });
    ...
    const specificationss = document.querySelector('#specificationss');
    
    if(specificationss.value){
      quill.root.innerHTML = specificationss.value;
    }

    postBtn.addEventListener('click',function(e){
      e.preventDefault();
      specificationss.value = quill.root.innerHTML
